        ...
        <div className="container ">
            <div className="row align-items-center g-5">
                <div className="col-lg-6 text-center text-lg-start">
                    ...
                    <p className="text-white animated slideInLeft mb-4 pb-2">Order Now, explore the Huts, and experience Western classics like never before!</p>
                    <a href="" className="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft customBtn">Place an Order</a>
                </div>
                <div className="col-lg-6 text-center text-lg-end overflow-hidden">
                    <img className="img-fluid heroBurgerPlatter" alt="heroBurgerPlatter" src={heroBurger} style={{ maxHeight: '551px'}}/>
              </div>
            </div>
        </div>
    </div>
